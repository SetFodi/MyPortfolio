                    ...
                    >
                        <Accordion.Header>
                            <Accordion.Trigger className="flex w-full items-center justify-start gap-x-4">
                                <div
                                    className={cn(
                                        ...
                                        openItem === item.id.toString()
                                            ...
                                            : "bg-muted/10 hover:bg-primary/10", // Adapted for dark theme
                                        questionClassName
                                    )}
                                >
                                    {item.icon && (
                                ...
                                <span
                                    className={cn(
                                        "text-muted-foreground ml-auto", // Added ml-auto to push icon to right if needed, or keep close
                        ...
                        <Accordion.Content asChild forceMount>
                            ...
                            >
                                <div className="ml-7 mt-1 md:ml-16">
                                    <div
                                        className={cn(
                                            "relative max-w-lg rounded-2xl bg-white/5 px-4 py-3 text-white/80 text-sm leading-relaxed",
                                            answerClassName
                                        )}
                                    >
                                        {item.answer}
