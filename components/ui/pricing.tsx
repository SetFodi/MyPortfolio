    ...
    return (
        <div className="container py-20 px-4 md:px-8 max-w-7xl mx-auto">
            <div className="text-center space-y-4 mb-20">
                <h2 className="text-4xl font-bold tracking-tight sm:text-6xl bg-clip-text text-transparent bg-gradient-to-b from-black to-black/60 dark:from-white dark:to-white/60">
                    {title}
                </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {plans.map((plan, index) => (
                    <motion.div
                        ...
                        className={cn(
                            `rounded-3xl p-8 flex flex-col relative overflow-hidden dark:bg-white/5 bg-gray-50 border backdrop-blur-xl transition-all duration-300`,
                            plan.isPopular
                                ? "border-primary/50 shadow-2xl shadow-primary/20 z-10 dark:bg-zinc-900/80 bg-white"
                                : "dark:border-white/10 border-gray-200 hover:border-gray-300 hover:dark:border-white/20 z-0",
                            index === 0 || index === 2
                    ...
                    >
                        ...
                        <div className="flex-1 flex flex-col relative z-10">
                            <h3 className="text-lg font-bold text-foreground uppercase tracking-widest mb-2">
                                {plan.name}
                            </h3>
                            ...
                            <hr className="dark:border-white/10 border-gray-200 my-6" />
